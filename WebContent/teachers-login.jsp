...
<body>
    ...
    <h1 class="main-title">To Access Teachers Panel</h1>
    <section id="login1">
       <div class="row">
           ...
           <div class="col-md-6">
            <div class="login">
                ...
                <p class="title">Login your Teacher Account</p>
                <form action="<%=request.getContextPath()%>/TeachersLoginServlet" method="get">
                <div class="row">
